...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DaGwQkhr.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D0UKwsfZ.mjs").then((n) => n.r),
...
const groupsC1lAT9ko = /* @__PURE__ */ Object.freeze({
  __proto__: null
});
export {
  groupsC1lAT9ko as g,
